-- ============================================================
-- Zion OS — STAGING (SQL EDITOR) · 01 · Base do schema
-- ============================================================
...
-- Cria as tabelas base (clientes, produtos, anuncios, agentes, ...) e set_updated_at().
...
-- [marcador de staging — NÃO faz parte do schema original]
-- Cria o marcador que os arquivos 02–08 exigem. Rode SOMENTE no zion-os-staging.
create table if not exists public.environment_metadata (
  environment text primary key,
  criado_em   timestamptz not null default now()
);
insert into public.environment_metadata (environment) values ('staging')
  on conflict (environment) do nothing;

-- ------------------------------------------------------------
-- Fonte: database/_legado/supabase-schema.sql
-- ------------------------------------------------------------
-- ============================================================
