...
<<<<<<< Updated upstream
=======
  pendencias_da_conta: "o que o Mercado Livre está cobrando",
  fotos_do_produto: "as fotos do produto",
  duplicatas_e_faltantes: "os códigos repetidos e as variações que faltam",
>>>>>>> Stashed changes
  ...
  diagnostico_de_agrupamento: "a grade dos produtos no Mercado Livre",
  saude_do_catalogo: "a saúde dos anúncios no Mercado Livre",
  o_que_eu_consigo: "o que eu consigo fazer",
  ...
  investigar: "a investigação em andamento",
