...
const DETALHE: Readonly<Record<string, { oQueFaz: string; precisaDe: readonly string[] }>> = {
  ...
  diagnostico_de_agrupamento: { oQueFaz: "Mede quanto da grade de cada produto está comprável, confere no Mercado Livre se os anúncios estão agrupados numa família, e aponta produtos com a mesma referência para conferir.", precisaDe: ["anúncios importados do Mercado Livre"] },
  saude_do_catalogo: { oQueFaz: "Mostra a saúde dos anúncios na nota do próprio Mercado Livre, quais estão no ar sem nunca ter vendido, quais não têm descrição, e a divisão entre Clássico e Premium.", precisaDe: ["uma importação do Mercado Livre feita depois de 24/08/2026"] },
