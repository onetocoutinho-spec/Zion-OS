    ...
    <>
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 pr-9 sm:pr-10">
          ...
          {/* 12px, e nao 11.
              A dica deixou de ser enfeite: e ela que carrega o DENOMINADOR
              ("de 880 anuncios gerados"), sem o qual "90" ao lado de "26 no ar"
              e uma conta impossivel. Informacao que resolve contradicao nao
              pode ser o menor texto da tela — 11px esta abaixo do piso que a
              regua usa para corpo de texto. */}
