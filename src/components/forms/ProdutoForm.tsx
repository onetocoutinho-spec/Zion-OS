        ...
        <FormGrid>
          ...
          <Field label="Tipo de produto" hint="Com variação → controle cada derivação (SKU) na aba Variações.">
            <select
              ...
              className="w-full rounded-lg border border-white/10 bg-surface-input px-3 py-2 text-sm text-zinc-200 outline-none transition-colors hover:border-white/20 focus:border-violet-500"
            >
              {TIPOS_PRODUTO.map((t) => (
