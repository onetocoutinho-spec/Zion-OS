...
// Compiler 010 — TypeScript: valores por Contexto, com o Símbolo transcrito para o dialeto TS.
...
export function generateTypeScript(validated: ValidatedIR): GeneratorOutput {
  ...
  return {
    artifact: ['export const tokens = {', ...entries, '} as const;'].join('\n'),
    diagnostics,
  };
}
